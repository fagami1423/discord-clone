...
exports.EditServerModal = void 0;
var z = require("zod");
    ...
    var onSubmit = function (values) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1["default"].patch("/api/servers/" + (server === null || server === void 0 ? void 0 : server.id), values)];
                case 1:
                    _a.sent();
                    form.reset();
                    router.refresh();
