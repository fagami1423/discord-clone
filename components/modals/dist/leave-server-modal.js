...
exports.LeaveServerModal = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setIsLoading(true);
                    return [4 /*yield*/, axios_1["default"].patch("/api/servers/" + (server === null || server === void 0 ? void 0 : server.id) + "/leave")];
                case 1:
                    _a.sent();
                    onClose();
                    router.refresh();
    ...
    return (React.createElement(dialog_1.Dialog, { open: isModalOpen, onOpenChange: onClose },
        React.createElement(dialog_1.DialogContent, { className: "bg-white text-black p-0 overflow-hidden" },
            React.createElement(dialog_1.DialogHeader, { className: "pt-8 px-6" },
                React.createElement(dialog_1.DialogTitle, { className: "text-2xl text-center font-bold" }, "Leave Server"),
                React.createElement(react_dialog_1.DialogDescription, { className: "text-center text-zinc-500" },
                    "Are you sure you want to leave ",
                    React.createElement("span", { className: "font-semibold text-indigo-500" }, server === null || server === void 0 ? void 0 : server.name),
                    "?")),
