...
exports.ServerChannel = function (_a) {
    ...
    return (React.createElement("button", { onClick: function () { }, className: utils_1.cn("group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1", (params === null || params === void 0 ? void 0 : params.channelId) === channel.id && "bg-zinc-700/20 dark:bg-zinc-700") },
        ...
        channel.name !== "general" && role !== client_1.MemberRole.GUEST && (React.createElement("div", { className: "ml-auto flex items-center gap-x-2" },
            React.createElement(action_tooltip_1.ActionTooltip, { label: "Edit" },
                React.createElement(lucide_react_1.Edit, { onClick: function () { return onOpen("editChannel", { server: server, channel: channel }); }, className: "hidden group-hover:block h-4 w-4 text-zinc-500 hover:text-zinc-600\n                            dark:text-zinc-400 dark:hover:text-zinc-300 transition" })),
            React.createElement(action_tooltip_1.ActionTooltip, { label: "Remove" },
                React.createElement(lucide_react_1.Trash, { onClick: function () { return onOpen("deleteChannel", { server: server, channel: channel }); }, className: "hidden group-hover:block h-4 w-4 text-zinc-500 hover:text-zinc-600\n                            dark:text-zinc-400 dark:hover:text-zinc-300 transition" })))),
