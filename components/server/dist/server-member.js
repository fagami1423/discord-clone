...
exports.ServerMember = function (_a) {
    ...
    return (React.createElement("button", { className: utils_1.cn("group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1", (params === null || params === void 0 ? void 0 : params.memberId) === member.id && "bg-zinc-700/20 dark:bg-zinc-700") },
        React.createElement(user_avatar_1.UserAvatar, { src: member.profile.imageUrl, className: "h-8 w-58 md:h-8 md:w-8" }),
        React.createElement("p", { className: utils_1.cn("font-semibold text-sm text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition", (params === null || params === void 0 ? void 0 : params.channelId) === member.id && "text-primary dark:text-zinc-200 dark:group-hover-text-white") }, member.profile.name)));
};
