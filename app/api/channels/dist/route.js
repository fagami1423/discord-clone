...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var profile, _a, name, type, searchParams, serverId, server, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a = _b.sent(), name = _a.name, type = _a.type;
                    ...
                    if (!serverId) {
                        return [2 /*return*/, new server_1.NextResponse("Server ID missing", { status: 400 })];
                    }
                    if (name === "general") {
                        return [2 /*return*/, new server_1.NextResponse("Name cannot be 'general'", { status: 400 })];
                    }
                    return [4 /*yield*/, db_1.db.server.update({
                            where: {
                                id: serverId,
                                members: {
                                    some: {
                ...
                case 4:
                    error_1 = _b.sent();
                    console.log("CHANNELS_POST", error_1);
